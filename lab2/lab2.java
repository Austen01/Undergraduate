...
public class Employee{
    ...
    public static void main(String[] args){
        // create new Employee instance with default constructor
        Employee emp1 = new Employee();
        emp1.setEmployeeName("Austen");
        emp1.setEmployeeNumber(001);
        emp1.setEmployeeAge(25);
        emp1.setEmployeeState("New Mexico");
        emp1.setEmployeeZip(88012);
        emp1.setAdvisors(21);
        emp1.setAdvisors(99);
        System.out.println(emp1.toString());

        // Employee emp2 = new Employee(emp1);
        // emp2.setEmployeeName("Nicole");
        // emp2.setEmployeeNumber(1);
        // emp2.setAdvisors(4);
        // emp2.setAdvisors(5);
        // emp2.setAdvisors(6);
        // System.out.println(emp2.toString());

        //create new Employee instance with copy constructor
        Employee emp2 = new Employee(emp1);
        emp2.setEmployeeName("Nicole");
        emp2.setEmployeeNumber(3);
        emp2.setAdvisors(4);
        emp2.setAdvisors(5);
        emp2.setAdvisors(6);
        System.out.println(emp2.toString());

        //test if two employee numbers match
        if(emp1.equals(emp2)){
            System.out.println("Emp1 and Emp2 have the same employee number");
        }else{
            System.out.println("Emp1 and Emp2 do not have the same employee number");
        }

        //print the array of distinct advisors from two objects
        System.out.println("Array of distinct advisors: " + Arrays.toString(getAllAdvisors(emp1, emp2)));
    }//end main
